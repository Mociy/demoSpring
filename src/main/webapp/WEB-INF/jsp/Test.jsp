...
<div id="App">
    ...
    <div id="header">
        <div id="one">
            ...
            <input type="text" v-model="title" onfocus="javascript:if(this.value=='请输入文章标题')this.value='';">

        </div>
        <p>请添加标签，多个标签的话，用“，”隔开</p>
        <input type="text"  v-model="tags" onfocus="javascript:if(this.value=='请添加标签')this.value='';">
    </div>
    <div id="test">
        <div id="div1">
        </div>
        ...
        vm = new Vue({
            ...
            methods: {
                get: function () {
                    ...
                    this.$http.post('http://localhost:8080/postContent', {
